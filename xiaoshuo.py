...
# #     }
# #     resp = requests.get(url, headers=headers)  # 发送 GET 请求
# #     resp.enconding = 'utf-8'  # 设置编码为 utf-8
# #     e = etree.HTML(resp.text)  # 解析 HTML 内容
# #     info = '\n'.join(e.xpath('//div[@class="m-post"]/p/text()'))  # 获取小说内容
# #     title = e.xpath('//h1/text()')[0]  # 获取小说标题
# #     url = f'https://dldl1.nsbuket.cc{e.xpath("//tr/td[2]/a/@href")[0]}'  # 获取下一页链接
# #     with open('斗罗大陆.txt', 'a', encoding='utf-8') as f:  # 以追加模式打开文件
# #         f.write(title + '\n\n' + info + '\n\n')  # 写入标题和内容
...
# import requests
# from lxml import etree
# url = 'https://www.22biqu.com/biqu5689/5760632.html'
# while True:
#     headers = {
...
#     resp.encoding = 'utf-8'  # 设置编码为 utf-8
#     e = etree.HTML(resp.text)  # 解析 HTML 内容
#     info = '\n'.join(e.xpath('//div[@class="content"]/p/text()'))  # 获取小说内容
#     title = e.xpath('//h1/text()')[0]  # 获取小说标题
#     url = f'https://www.22biqu.com{e.xpath("//div[@class='bottem1']/a/@href")[0]}'  # 获取下一页链接
#     with open(' 斗破苍穹.txt'   , 'a', encoding='utf-8') as f:  # 以追加模式打开文件
#         f.write(title + '\n\n' + info + '\n\n')  # 写入标题和内容

#         if url == 'https://www.22biqu.com/biqu5689/5760632.html':
#             print('已到达最后一页')
#             break